# Set up directory
setwd("C:/Users/wangha/Desktop/vEDA_AhR_version_9/Zenodo/Figures/Figure 5C-D")
library(dplyr)
library(tidyr)
library(ggplot2)
library(UpSetR)
...
upset(df_ID_plot, 
      sets = c("Schmilka", "Zehren", "Sandau", "Magdeburg", "Lauenburg", 'Wittenberg', 'Torgau', 'Dresden', 'Mulde', 'Domitz'),
